...
/**
 * Handles requests to /scrape.
 */
class Scrape implements ControllerInterface {
    /**
     * Router instance.
     *
     * @var \Slim\Router
     ...
     *
     * @apiEndpointResponse 200 schema/scrape/listDaemons.json
     *
     ...
     *
     * @apiEndpointResponse 201 schema/scrape/scheduleJob.json
     *
     * @param \Psr\Http\Message\ServerRequestInterface $request
     * @param \Psr\Http\Message\ResponseInterface $response
     *
    ...
    public function scheduleJob(ServerRequestInterface $request, ResponseInterface $response) : ResponseInterface {
        $command = $this->commandFactory->create('ScheduleJob');
